...
<div align="center">
  <img src="http://travis-ci.org/caiogondim/pedant-emitter.js.svg?branch=master" alt="Travis CI"> <img src="http://img.badgesize.io/caiogondim/pedant-emitter.js/master/build/pedant-emitter.es.js?compression=gzip"> <img src='https://coveralls.io/repos/github/caiogondim/pedant-emitter.js/badge.svg' alt='Coverage Status' />
</div>
